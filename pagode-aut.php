...
<body>
    ...
    <article class="container">
        <div class="my-5 text-center">
            <h1 tabindex="0" class="display-5">História do Pagode</h1>
        </div>
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                <p tabindex="0" class="text-dark mt-2">
        ...
        <div class="row">
            <div class="col-12">
                <h2>Hoje, há dois tipos de pagode</h2>
                <p tabindex="0" class="text-dark">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <p tabindex="0" class="text-dark mt-4">
                    Em 1975 Martinho da Vila gravou o álbum ‘Pelo Telefone’, como uma homenagem ao samba e ao compositor.
                </p>
            </div>
        </div>
