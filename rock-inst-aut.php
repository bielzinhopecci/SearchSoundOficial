...
<section class="container">
  <h1 tabindex="0" class="text-center pt-5 mt-3 pb-5">Instrumentos do Rock 'n' Roll</h1>
    <div class="row pb-1">
    <div class="lista-item py-5 col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <input class="trigger-input" id="faq-titulo-1" type="checkbox">
            ...
            <h2 tabindex="0" class="text-center mt-2 pb-4">Guitarra</h2>
          <label for="faq-titulo-1">
            <h6 tabindex="0" class="faq-titulo">Descrição</h6>
          </label>
          <p tabindex="0" class="faq-conteudo">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo, nemo nulla.</p>
      </div>
    </div>
...
<section class="container">
  <hr class="prop">
      ...
      <h1 tabindex="0" class="text-center pt-3">LENDAS DO ROCK</h1>
      <span tabindex="0" class="text-center h6 d-block">CONHEÇA OS MELHORES MÚSICOS DE TODOS OS TEMPOS </span>

  <div class="row pt-3">

    <div class="col-12 col-md-4">
      <h3 tabindex="0" class="pb-2 mt-5 text-center">Jimi Hendrix - Guitarrista</h3>
      <p tabindex="0" class="text-justify">
        Jimmy Hendrix (1942-1970) é o melhor guitarrista de todos os tempos, segundo a Rolling Stone americana.
    ...
    <div class="col-12 col-md-4">
      <h3 tabindex="0" class="pb-2 mt-5 text-center">John Bonham - Baterista</h3>
      <p tabindex="0" class="text-justify">
        Bonzo foi o mais influente, o mais criativo e um dos mais pesados bateristas de todos os tempos. 
    ...
    <div class="col-12 col-md-4">
      <h3 tabindex="0" class="pb-2 mt-5 text-center">Jerry Lee Lewis - Pioneiro</h3>
      <p tabindex="0" class="text-justify">
        Jerry Lee Lewis um dos pioneiros e maiores estrelas do rock dos anos 50, mestre do piano com o apelido de "The Killer", 
