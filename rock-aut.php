...
<section class="container">
        ...
        <div class="row">
          <div class="col-12 col-md-5 mt-2">
            <strong tabindex="0" class="mt-5">O rock na década de 1950: primeiros passos</strong>
              <p tabindex="0" class="text-dark mt-4 text-justify">
                É a fase inicial deste estilo, ganhando a simpatia dos jovens que se identificavam com o estilo rebelde dos 
          ...
          <div class="col-12 col-md-7 mt-2">
            <strong tabindex="0" class="mt-0">O rock nos anos 60: rebeldia e transgressão</strong>
              <p tabindex="0" class="text-dark mt-3 text-justify"> 
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-7 mt-3">
          <strong tabindex="0" class="mt-5">Anos 90: década de fusões e experimentações</strong>
            ...
            <p tabindex="0" class="text-dark mb-4 text-justify">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <p tabindex="0" class="text-dark mt-4">
