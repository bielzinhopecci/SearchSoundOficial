<footer class="bg text-white mt-4">
        <div class="container py-4">
          <div class="row">
            <div class="col-md-2 col-6">
              <h4 tabindex="0" class="h6">Rock</h4>
            ...
            <div class="col-md-2 col-6">
              <h4 tabindex="0" class="h6">Samba</h4>
              <ul class="list-unstyled">
             ...
             <div class="col-md-2 col-6">
              <h4 tabindex="0" class="h6">Pagode</h4>
              <ul class="list-unstyled">
            ...
            <div class="col-md-4">
              <h4 tabindex="0" class="h6">CONTATO</h4>
              <ul class="list-unstyled text-contato">
                <li>contato@searchsound.com.br</li>
                <li>99 99999-9999</li>
              </ul>
            </div>

            <div class="text-center col-12 col-sm-12 col-md-2 pr-1">
