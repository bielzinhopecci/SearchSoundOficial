...
<html lang="pt-br">
  <head>
    ...
    <title>Search Sound - Instrumentos do Rock</title>
  ...
  <h1 class="text-center pt-5 mt-3 pb-5">Instrumentos do Rock 'n' Roll</h1>
    ...
    <div class="lista-item py-5 col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <input class="trigger-input" id="faq-titulo-1" type="checkbox">
            ...
            <h2 class="text-center mt-2 pb-4">Guitarra</h2>
          <label for="faq-titulo-1">
            <h6 class="faq-titulo">Descrição</h6>
          </label>
          <p class="faq-conteudo">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo, nemo nulla.</p>
      </div>
    </div>
    ...
    <div class="lista-item border-middle py-5 col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <input class="trigger-input" id="faq-titulo-2" type="checkbox">
		    <div class="trigger-wrapper">
          <img class="icon-instrumentos" src="dist/img/icones-rock/drums.png" alt="Bateria">
          <h2 class="text-center">Bateria</h2>
    ...
    <div class="lista-item py-5 col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <input class="trigger-input" id="faq-titulo-3" type="checkbox">
        ...
        <label for="faq-titulo-3">
          <h5 class="faq-titulo">Descrição</h5>
        </label>
        <p class="faq-conteudo">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo, nemo nulla.</p>
      </div>
    </div>
  ...
  <div class="row mt-1">
    <div class="lista-item py-5 col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <input class="trigger-input" id="faq-titulo-4" type="checkbox">
            ...
            <h2 class="text-center mt-2 pb-4">Piano</h2>
    ...
    <div class="lista-item border-middle py-5 col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <input class="trigger-input" id="faq-titulo-5" type="checkbox">
		    <div class="trigger-wrapper">
          <img class="icon-instrumentos" src="dist/img/icones-rock/bass.png" alt="Baixo">
          <h2 class="text-center">Baixo</h2>
...
<section class="container">
  <hr class="prop">
      <h1 class="text-center pt-3">LENDAS DO ROCK</h1>
      <span class="text-center h6 d-block">CONHEÇA OS MELHORES MÚSICOS DE TODOS OS TEMPOS </span>

    <div class="col-md-12">
      <img class="img-metallica" src="dist/img/4.png" alt="foto">
    </div>

  <div class="row pt-3">
      <div class="col-md-12">
        <h3 class="pb-2 text-center">Jimi Hendrix - Guitarrista</h3>
        <p>Jimmy Hendrix (1942-1970) é o melhor guitarrista de todos os tempos, segundo a Rolling Stone americana.
  ...
  <div class="row pt-5">
        <div class="col-md-12">
          <h3 class="pb-2 text-center">John Bonham - Baterista</h3>
          <p>Bonzo foi o mais influente, o mais criativo e um dos mais pesados bateristas de todos os tempos. 
            Por isso, mesmo que não esteja mais entre nós, será sempre o maior baterista de todos os tempos, 
  ...
  <div class="row pt-5">
      <div class="col-md-12">
        <h3 class="pb-2 text-center">Jerry Lee Lewis - Pioneiro</h3>
        <p>Jerry Lee Lewis um dos pioneiros e maiores estrelas do rock dos anos 50, mestre do piano com o apelido de "The Killer", 
          Jerry surgiu cantando música gospel nas igrejas pentecostais do sul dos Estados Unidos, mas desde cedo mostrou talento nato
