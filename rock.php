...
<section class="container">
        ...
        <div class="row">
          <div class="col-md-8">
            <p class="text-dark">Este gênero musical de grande sucesso surgiu nos Estados Unidos nos anos 50 (década de 1950). 
          ...
          <div class="row">
            <div class="col-md-8 mt-2">
              <strong class="mt-5">O rock na década de 1950: primeiros passos</strong>
                <p class="text-dark mt-4">É a fase inicial deste estilo, ganhando a simpatia dos jovens que se identificavam com o estilo rebelde dos 
